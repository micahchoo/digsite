...
const EXPECTATIONS: Record<string, Expectation> = {
  ...
  'GET /images/:id/source': {
    method: 'GET',
    path: (fx) => `/images/${fx.imageId}/source`,
    outsider: 403,
  },
  ...
  'POST /images/:id/extract': {
    method: 'POST',
    path: (fx) => `/images/${fx.imageId}/extract`,
    outsider: 403,
  },
  'PATCH /images/:id': {
    method: 'PATCH',
  ...
  'POST /boards/:id/images/copy': {
    method: 'POST',
    path: (fx) => `/boards/${fx.bPrivateId}/images/copy`,
    outsider: 403,
  },
  'GET /boards/:id/images/download': {
    method: 'GET',
    path: (fx) => `/boards/${fx.bPrivateId}/images/download`,
    outsider: 403,
  },
  'GET /boards/:id/find': {
    method: 'GET',
  ...
  'GET /boards/:id/relation-web': {
    method: 'GET',
    path: (fx) => `/boards/${fx.bPrivateId}/relation-web?relation=x`,
    outsider: 403,
  },
  ...
  'POST /boards/:id/images/by-sha256': {
    method: 'POST',
